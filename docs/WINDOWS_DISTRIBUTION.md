...
The active source line is `1.0.0-rc.6`, with numeric desktop build version `1.0.0.6`. It does not have an accepted artifact yet and does not supersede the source-bound 0.9.19 evidence.
