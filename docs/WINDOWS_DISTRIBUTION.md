...
The active source line is `1.0.0-rc.4`, with numeric desktop build version `1.0.0.4`. It does not have an accepted artifact yet and does not supersede the source-bound 0.9.19 evidence.
