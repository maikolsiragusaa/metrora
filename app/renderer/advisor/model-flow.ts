  ...
  return [
    {
      ...
      content: [
        ...
        'The supplied Metrora read-only Tools are already authorized for this turn. When one is needed, call it directly; do not ask the user for permission to read authorized Metrora data.',
  ...
  return [
    {
      ...
      content: [
        ...
        'The supplied Metrora read-only Tools are already authorized for this turn; do not ask the user for permission to read authorized Metrora data.',
