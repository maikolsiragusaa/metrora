...
import { OpenCode } from './sections/OpenCode'
  ...
  return (
    ...
    >
      ...
      <div className="ct">
        ...
        <UpdateBanner />
        {section !== 'opencode' && section !== 'bench' && <DailyBudgetBanner payload={overview.data ?? null} provider={provider} />}
        ...
        {section === 'bench' ? (
          ...
          <Plans period={period} refreshToken={refreshToken} onNavigate={navigate} onRefresh={refreshVisible} refreshing={overview.loading} ready={ready} />
        ) : section === 'settings' ? (
        ...
        {section !== 'settings' && section !== 'opencode' && section !== 'bench' && (
          <Hint
            items={[
