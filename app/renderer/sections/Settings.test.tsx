...
describe('Settings', () => {
  beforeEach(() => {
    ...
    mocks.chooseDirectory.mockResolvedValue('/Users/fixture/Exports')
  ...
  it('chooses an export folder and exports the selected format and provider', async () => {
    ...
    expect(await screen.findByText('/Users/fixture/Exports')).toBeInTheDocument()
    await user.click(screen.getByRole('button', { name: 'JSON' }))
    await user.click(screen.getByLabelText('Provider'))
    await user.click(screen.getByRole('option', { name: 'Claude' }))
    await user.click(screen.getAllByRole('button', { name: 'Export' }).at(-1)!)
    expect(mocks.exportData).toHaveBeenCalledWith('json', 'claude', '/Users/fixture/Exports')
    expect(await screen.findByText('Exported to /Users/fixture/Exports')).toBeInTheDocument()
  })
