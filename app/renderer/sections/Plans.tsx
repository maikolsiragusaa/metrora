...
export function Plans({ period, refreshToken = 0, onNavigate, onAskHarness, onRefresh, refreshing = false, ready = true }: { period: Period; refreshToken?: number; onNavigate?: (section: Section, pane?: SettingsPane) => void; onAskHarness?: () => void; onRefresh?: () => void; refreshing?: boolean; ready?: boolean }) {
  ...
  return (
    <>
      <div className="bar">
        ...
        <div className="sp" />
        {onAskHarness && <button type="button" className="btn btn-s ask-harness-button" onClick={onAskHarness}>Ask Harness <span aria-hidden="true">↗</span></button>}
