  ...
  return (
    <section className="workspace-organization-preview" aria-labelledby="workspace-organization-title">
      <div className="workspace-organization-heading">
        ...
        <div>
          <div className="workspace-organization-title-row"><h3 id="workspace-organization-title">Organization workspaces</h3><span className="workspace-preview-badge">Preview</span></div>
          <p>In the future, workspace owners will be able to manage members, multiple workspaces, and shared projects.</p>
        </div>
      </div>
