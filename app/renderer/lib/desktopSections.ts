...
export const DESKTOP_SECTION_CAPABILITIES: Record<Section, DesktopSectionCapabilities> = {
  ...
  opencode: { period: false, customRange: false, provider: false, claudeConfig: false, globalRefresh: false },
  bench: { period: false, customRange: false, provider: false, claudeConfig: false, globalRefresh: false },
  plans: {
    period: false,
    customRange: false,
    provider: false,
