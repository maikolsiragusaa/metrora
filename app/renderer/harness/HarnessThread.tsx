      ...
      <div className="harness-v3-thread-inner">
        ...
        {messages.map(message => message.role === 'user'
          ...
          : message.answer
            ...
            : <article key={message.id} className="harness-v3-assistant-plain assistant-message"><div className="harness-v3-turn-label"><MetroraMark size={20} /><span>Metrora Harness</span></div><p>{message.text}</p></article>
        )}
