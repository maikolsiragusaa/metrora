...
const ARGV_CASES: Array<{ channel: string; args: unknown[]; argv: string[] }> = [
  ...
  { channel: 'metrora:getSessions', args: ['week', 'all'], argv: ['sessions', '--format', 'json', '--include-token-activity', '--period', 'week'] },
  { channel: 'metrora:getSessions', args: ['30days', 'claude', { from: '2026-07-01', to: '2026-07-11' }], argv: ['sessions', '--format', 'json', '--include-token-activity', '--period', '30days', '--provider', 'claude', '--from', '2026-07-01', '--to', '2026-07-11'] },
