...
Metrora is distributed under the MIT License. Incorporated third-party portions retain their original notices and licence terms. Contributions are licensed under the repository's MIT terms. See [`THIRD_PARTY_NOTICES.md`](THIRD_PARTY_NOTICES.md) and [`LICENSES/`](LICENSES/).
