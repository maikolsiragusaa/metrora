...
// ---------------------------------------------------------------------------
// detectMcpProfileOpportunity — project-scoping recommendations
// ---------------------------------------------------------------------------

describe('detectMcpProfileOpportunity', () => {
  ...
  it('flags a server loaded across projects but invoked only in one hot project', () => {
    ...
    const finding = detectMcpProfileOpportunity(projects)
    expect(finding).not.toBeNull()
  ...
  it('does not flag servers used evenly across loaded projects', () => {
    ...
    expect(detectMcpProfileOpportunity(projects)).toBeNull()
  })
  ...
  it('does not duplicate low tool coverage findings for the same server', () => {
    ...
    expect(detectMcpProfileOpportunity(projects, coverage)).toBeNull()
  })
})
