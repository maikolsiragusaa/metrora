...
- `metrora-mark.svg` — Graphite mark for light surfaces.
- `metrora-mark-inverse.svg` — Warm Off-White mark for dark surfaces.
...
| Warm Off-White | `#FAF7F2` | editorial backgrounds and inverse mark |
