...
- Current development version: `1.0.0-rc.2`
- Current desktop build version: `1.0.0.2`
...
The active source line is `1.0.0-rc.2`, with desktop build metadata `1.0.0.2`. No artifact at this version is accepted, signed or published merely because the metadata exists.
